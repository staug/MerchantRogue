        ...
        for event in event_list:
            ...
            if (event.type == pygame.MOUSEBUTTONDOWN
                ...
                if id(clicked_plane) != id(self):
                    ...
                    #
                    clicked_plane.clicked(button_name, event=event)
